...
from scratch in a modular Python codebase.  Next, we reproduce the
...
The repository contains the Python source code, scripts for each figure, and
dependency information.  The generated figures are build artifacts that can be
...
Generated Python figures are stored in \texttt{figures/}.
